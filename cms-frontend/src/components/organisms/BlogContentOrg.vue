...
const profile = ref({
    ...
    text: "Sit qui sit ut fugiat. Consectetur minim esse exercitation dolore ullamco esse laborum do tempor ea cillum. Qui laborum reprehenderit eu et dolore dolore mollit exercitation aute fugiat."
});
